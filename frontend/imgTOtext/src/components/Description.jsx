...
const Description = () => {
  return (
    ...
    <img src={assets.sample_img_1} alt="" className='w-60 xl:w-96 rounded-lg'/>
    <div >
        <h2 className='text-3xl font-medium max-w-lg md-4 '>Introducing the AI-Powered Text to Image Generator</h2>
        <p className='text-gray-600 mb-4'>
            Easily bring your ideas to life with our free AI
            image generator. Whether you need stunning visuals or unique imagery, our tool transforms  your text Intoeye-catching 
