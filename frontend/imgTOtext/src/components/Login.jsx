        ...
        className='relative bg-white p-10 rounded-xl text-slate-500'>
           ...
           {state !== 'Login' && 
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
                ...
                type="text" placeholder='Full Name' className='outline-none text-sm' required/>
            </div>
            }
            ...
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                ...
                type="email" placeholder='Email id' className='outline-none text-sm' required/>
            </div>
            ...
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                ...
                type="password" placeholder='Password' className='outline-none text-sm' required/>
            </div>
